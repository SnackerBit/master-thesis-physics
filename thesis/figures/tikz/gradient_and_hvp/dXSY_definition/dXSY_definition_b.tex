...
\begin{document}
	...
	\def\thetaWidth{5.3*\smallTensorWidth}
	...
	\def\additionalXTextOffsetScale{0.7}
	\begin{tikzpicture}
		\node[tensorOperatorSmall, minimum width=\thetaWidth, minimum height=1.2*\smallTensorWidth, fill=generalTensorColor, inner sep=0] (dXSY) at (0, 0) {$\text{d}(XS^{2\alpha-1}Y^\dagger)$};
		...
		\node[] () at (\posX-\tensorDistance-\additionalXTextOffsetScale*\defaultTextOffsetLarge, \smallTensorWidth/2+\defaultTextOffsetLarge) {$\text{d}X$};
		\node[tensorAuxillarySmall, fill=generalTensorColor] (S) at (\posX, 0) {};
		\node[] () at (\posX, \smallTensorWidth/2+\defaultTextOffsetLarge) {$S^{2\alpha-1}$};
		\node[tensorAuxillarySmall, fill=generalTensorColor] (Yd) at (\posX+\tensorDistance, 0) {};
		\node[] () at (\posX+\tensorDistance+\additionalXTextOffsetScale*\defaultTextOffsetLarge, \smallTensorWidth/2+\defaultTextOffsetLarge) {$Y^*$};
		...
		\node[tensorAuxillarySmall, fill=generalTensorColor] (S) at (\posX, 0) {};
		\node[] () at (\posX, \smallTensorWidth/2+\defaultTextOffsetLarge) {$S^\prime$};
		\node[tensorAuxillarySmall, fill=generalTensorColor] (Yd) at (\posX+\tensorDistance, 0) {};
		...
		\node[tensorAuxillarySmall, fill=generalTensorColor] (X) at (\posX-\tensorDistance, 0) {};
		\node[] () at (\posX-\tensorDistance-\additionalXTextOffsetScale*\defaultTextOffsetLarge, \smallTensorWidth/2+\defaultTextOffsetLarge) {$X$};
		\node[tensorAuxillarySmall, fill=generalTensorColor] (S) at (\posX, 0) {};
		\node[] () at (\posX, \smallTensorWidth/2+\defaultTextOffsetLarge) {$S^{2\alpha-1}$};
		\node[tensorAuxillarySmall, fill=generalTensorColor] (Yd) at (\posX+\tensorDistance, 0) {};
		\node[] () at (\posX+\tensorDistance+\additionalXTextOffsetScale*\defaultTextOffsetLarge, \smallTensorWidth/2+\defaultTextOffsetLarge) {$\text{d}Y^*$};
