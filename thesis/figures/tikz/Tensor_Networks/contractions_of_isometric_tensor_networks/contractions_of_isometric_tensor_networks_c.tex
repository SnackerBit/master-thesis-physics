...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\begin{pgfonlayer}{bg}
			...
			\draw[virtualLeg] ({\posXNC+\openLegLength*cos(-150)}, {\posYNC+\openLegLength*sin(-150)}) -- (NC);
			\draw[virtualLeg] ({\posXNF+\openLegLength*cos(60)}, {\posYNF+\openLegLength*sin(60)}) -- (NF);
			\draw[virtualLeg] ({\posXNH+\openLegLength*cos(-50)}, {\posYNH+\openLegLength*sin(-50)}) -- (NH);
			\draw[virtualLeg] ({\posXNI+\openLegLength*cos(-20)}, {\posYNI+\openLegLength*sin(-20)}) -- (NI);
			\draw[virtualLeg] ({\posXNJ+\openLegLength*cos(30)}, {\posYNJ+\openLegLength*sin(30)}) -- (NJ);
		\end{pgfonlayer}
		...
		\begin{pgfonlayer}{bg}
			...
			\draw[virtualLeg] ({\posXNpC+\openLegLength*cos(-150)}, {\posYNpC+\openLegLength*sin(-150)}) -- (NpC);
			\draw[virtualLeg] ({\posXNpF+\openLegLength*cos(60)}, {\posYNpF+\openLegLength*sin(60)}) -- (NpF);
			\draw[virtualLeg] ({\posXNpH+\openLegLength*cos(-50)}, {\posYNpH+\openLegLength*sin(-50)}) -- (NpH);
			\draw[virtualLeg] ({\posXNpI+\openLegLength*cos(-20)}, {\posYNpI+\openLegLength*sin(-20)}) -- (NpI);
			\draw[virtualLeg] ({\posXNpJ+\openLegLength*cos(30)}, {\posYNpJ+\openLegLength*sin(30)}) -- (NpJ);
		\end{pgfonlayer}
		...
		\begin{pgfonlayer}{bg}
			...
			\draw[virtualLegWithoutArrows] (NpC) -- ++({\openLegLength*cos(-150)}, {\openLegLength*sin(-150)}) -- ++(0, -\ccdistance) -- (NC);
			\draw[virtualLegWithoutArrows] (NpF) -- ++({\openLegLength*cos(60)}, {\openLegLength*sin(60)}) -- ++(0, -\ccdistance) -- (NF);
			\draw[virtualLegWithoutArrows] (NpH) -- ++({\openLegLength*cos(-50)}, {\openLegLength*sin(-50)}) -- ++(0, -\ccdistance) -- (NH);
			\draw[virtualLegWithoutArrows] (NpI) -- ++({\openLegLength*cos(-20)}, {\openLegLength*sin(-20)}) -- ++(0, -\ccdistance) -- (NI);
			\draw[virtualLegWithoutArrows] (NpJ) -- ++({\openLegLength*cos(30)}, {\openLegLength*sin(30)}) -- ++(0, -\ccdistance) -- (NJ);
		\end{pgfonlayer}
	\end{tikzpicture}
\end{document}