...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\node[tensorPhysicalSmall] (T31) at (2*\tensorDistance, 0) {};
		\node[tensorOrthoCenterSmall] (T32) at (2*\tensorDistance, \tensorDistance) {};
