...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\node[tensorAuxillarySmall, fill=white, draw=white] (W1p) at (-\diagonalDistance-\ketDiagonalShiftX, -\diagonalDistance+\ketDiagonalShiftY-\braketDistance) {};
		...
		\def\posX{(\diagonalDistance+(2*\smallestDistance+\diagonalDistance)*\openAuxillaryLegMultiplier+\openAuxillaryLegEnlargementX+2*\equationDistance+3*\envLegDistanceVirtualHorizontal+\svdDistanceAuxX)}
		
		\node[tensorPhysicalSmall, fill=generalTensorColor] (U) at ({\posX-\svdDistanceAuxX}, {\posY-\svdDistanceAuxY}) {};
		\node[] () at ({\posX-\svdDistanceAuxX-sin(45)*(\smallTensorWidth/2+\defaultTextOffsetLarge)}, {\posY-\svdDistanceAuxY+cos(45)*(\smallTensorWidth/2+\defaultTextOffsetLarge)}) {$U$};
		\node[tensorPhysicalSmall, fill=generalTensorColor] (S) at ({\posX}, {\posY}) {};
		\node[] () at ({\posX}, {\posY-\smallTensorWidth/2-\defaultTextOffsetLarge}) {$S$};
		\node[tensorPhysicalSmall, fill=generalTensorColor] (Vc) at ({\posX+\svdDistanceAuxX}, {\posY+\svdDistanceAuxY}) {};
		\node[] () at ({\posX+\svdDistanceAuxX}, {\posY+\svdDistanceAuxY-\smallTensorWidth/2-\defaultTextOffsetLarge}) {$V^*$};
		
		\begin{pgfonlayer}{bg}
			\draw[auxillaryLegSmall] (Vc)+({\envLegDistanceAuxillaryX}, {\envLegDistanceAuxillaryY}) -- (Vc);
			\draw[auxillaryLegSmall] (Vc) -- ++({\envLegDistanceAuxillaryX}, {\envLegDistanceAuxillaryY});
			\draw[auxillaryLegSmall] (U)+({-\envLegDistanceAuxillaryX}, {-\envLegDistanceAuxillaryY}) -- (U);
			\draw[virtualLegSmall] (U)+({\envLegDistanceVirtualDiagonal}, {\envLegDistanceVirtualDiagonal}) -- (U);
			\draw[virtualLegSmall] (U)+({-\envLegDistanceVirtualDiagonal}, {-\envLegDistanceVirtualDiagonal}) -- (U);
			\draw[auxillaryLegSmall] (U) -- (S);
			\draw[auxillaryLegSmall] (Vc) -- (S);
			\draw[auxillaryLegSmall] (S) -- (Vc);
		\end{pgfonlayer}
		...
		\begin{scope}[xshift=\subpictureXshift, yshift=\subpictureYshift]
			...
			\node[tensorAuxillarySmall] (W1) at (0, 0) {};
			\node[] () at (0, -\smallTensorWidth/2-\defaultTextOffsetLarge) {$W_1^\prime$};
			\begin{pgfonlayer}{bg}
				\draw[auxillaryLegSmall] (W1) -- ++({\envLegDistanceAuxillaryX}, {\envLegDistanceAuxillaryY});
				\draw[auxillaryLegSmall] (W1)+({-\envLegDistanceAuxillaryX}, {-\envLegDistanceAuxillaryY}) -- (W1);
				\draw[virtualLegSmall] (W1)+({\envLegDistanceVirtualDiagonal}, {\envLegDistanceVirtualDiagonal}) -- (W1);
				\draw[virtualLegSmall] (W1)+({-\envLegDistanceVirtualDiagonal}, {-\envLegDistanceVirtualDiagonal}) -- (W1);
			\end{pgfonlayer}
			\node[] () at ({\envLegDistanceVirtualHorizontal+\equationDistance/2}, 0) {$=$};
			\node[tensorPhysicalSmall, fill=generalTensorColor] (U) at ({2*\envLegDistanceVirtualHorizontal+\equationDistance}, 0) {};
			\node[] () at ({2*\envLegDistanceVirtualHorizontal+\equationDistance-sin(45)*(\smallTensorWidth/2+\defaultTextOffsetLarge)}, {cos(45)*(\smallTensorWidth/2+\defaultTextOffsetLarge)}) {$U$};
			\node[tensorPhysicalSmall, fill=generalTensorColor] (Vc) at ({2*\envLegDistanceVirtualHorizontal+\svdDistanceAuxX+\equationDistance}, 0) {};
			\node[] () at ({2*\envLegDistanceVirtualHorizontal+\svdDistanceAuxX+\equationDistance}, -\smallTensorWidth/2-\defaultTextOffsetLarge) {$V^*$};
			\begin{pgfonlayer}{bg}
				\draw[auxillaryLegSmall] (Vc) -- ++({\envLegDistanceAuxillaryX}, {\envLegDistanceAuxillaryY});
				\draw[auxillaryLegSmall] (U)+({-\envLegDistanceAuxillaryX}, {-\envLegDistanceAuxillaryY}) -- (U);
				\draw[virtualLegSmall] (U)+({\envLegDistanceVirtualDiagonal}, {\envLegDistanceVirtualDiagonal}) -- (U);
				\draw[virtualLegSmall] (U)+({-\envLegDistanceVirtualDiagonal}, {-\envLegDistanceVirtualDiagonal}) -- (U);
				\draw[auxillaryLegSmall] (U) -- (Vc);
			\end{pgfonlayer}
		\end{scope}
