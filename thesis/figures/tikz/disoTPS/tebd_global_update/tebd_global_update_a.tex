...
\begin{document}
	...
	\begin{tikzpicture}
		...
		% ticklabels
		\node[] () at (\tensorDistance/2, -\coordinateSystemDistance-\ticklength/2-\defaultTextOffsetLarge) {$1$};
		\node[] () at (3*\tensorDistance/2, -\coordinateSystemDistance-\ticklength/2-\defaultTextOffsetLarge) {$2$};
		\node[] () at (5*\tensorDistance/2, -\coordinateSystemDistance-\ticklength/2-\defaultTextOffsetLarge) {$3$};
		\node[] () at (7*\tensorDistance/2, -\coordinateSystemDistance-\ticklength/2-\defaultTextOffsetLarge) {$4$};
		\node[] () at (9*\tensorDistance/2, -\coordinateSystemDistance-\ticklength/2-\defaultTextOffsetLarge) {$5$};
		
		\node[] () at (-\coordinateSystemDistance-\ticklength/2-\defaultTextOffsetLarge, \tensorDistance/2) {$1$};
		\node[] () at (-\coordinateSystemDistance-\ticklength/2-\defaultTextOffsetLarge, 3*\tensorDistance/2) {$2$};
		\node[] () at (-\coordinateSystemDistance-\ticklength/2-\defaultTextOffsetLarge, 5*\tensorDistance/2) {$3$};
		\node[] () at (-\coordinateSystemDistance-\ticklength/2-\defaultTextOffsetLarge, 7*\tensorDistance/2) {$4$};
		\node[] () at (-\coordinateSystemDistance-\ticklength/2-\defaultTextOffsetLarge, 9*\tensorDistance/2) {$5$};
