...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\node[tensorOrthoCenterSmall, ellipse, minimum width=\smallTensorWidth, minimum height=\thetaHeight, fill=white] (theta) at (0, 0) {};
		\node[] () at (\smallTensorWidth/2+\defaultTextOffsetLarge, 0) {$\theta$};
		\begin{pgfonlayer}{bg}
			...
			\draw[virtualLegSmall, transform canvas={xshift={-\defaultLegSeperationSmall*sin(0)/2}, yshift={\defaultLegSeperationSmall*cos(0)/2}}] (U.center)+(-\tensorDistance+\unitaryWidth/2, 0) -- ++(-\unitaryWidth/2, 0);
			\draw[virtualLegSmall, transform canvas={xshift={\defaultLegSeperationSmall*sin(0)/2}, yshift={-\defaultLegSeperationSmall*cos(0)/2}}] (U.center)+(-\tensorDistance+\unitaryWidth/2, 0) -- ++(-\unitaryWidth/2, 0);
		...
		\end{pgfonlayer}
		\node[] () at (-\tensorDistance/2, \defaultLegSeperationSmall+\defaultTextOffsetLarge) {$i^\prime$};
		\node[] () at (-\tensorDistance/2, -\defaultLegSeperationSmall-\defaultTextOffsetLarge) {$j^\prime$};
		\node[] () at (-3*\tensorDistance/2, \defaultLegSeperationSmall+\defaultTextOffsetLarge) {$i$};
		\node[] () at (-3*\tensorDistance/2, -\defaultLegSeperationSmall-\defaultTextOffsetLarge) {$j$};
		...
		\node[] () at (\smallTensorWidth/2+\defaultTextOffsetLarge+\defaultDistanceEquations/2, 0) {$=$};
		\def\posX{\smallTensorWidth/2+\defaultTextOffsetLarge+\defaultDistanceEquations+\tensorDistance-\unitaryWidth/2}
	
		\node[tensorOrthoCenterSmall, ellipse, minimum width=\smallTensorWidth, minimum height=\thetaHeight, fill=white] (theta) at (\posX, 0) {};
		\node[] () at (\posX+\smallTensorWidth/2+\defaultTextOffsetLarge, 0) {$\tilde{\theta}$};
		
		
		\draw[virtualLegSmall, transform canvas={xshift={-\defaultLegSeperationSmall*sin(0)/2}, yshift={\defaultLegSeperationSmall*cos(0)/2}}] (theta.center)+(-\tensorDistance+\unitaryWidth/2, 0) -- ++(-\unitaryWidth/2, 0);
		\draw[virtualLegSmall, transform canvas={xshift={\defaultLegSeperationSmall*sin(0)/2}, yshift={-\defaultLegSeperationSmall*cos(0)/2}}] (theta.center)+(-\tensorDistance+\unitaryWidth/2, 0) -- ++(-\unitaryWidth/2, 0);
		...
		\node[] () at (\posX-\tensorDistance/2, \defaultLegSeperationSmall+\defaultTextOffsetLarge) {$i^\prime$};
		\node[] () at (\posX-\tensorDistance/2, -\defaultLegSeperationSmall-\defaultTextOffsetLarge) {$j^\prime$};
		...
		\node[] () at (\posX+\smallTensorWidth/2+\defaultTextOffsetLarge+\defaultDistanceEquations/2, 0) {$=$};
		\def\posX{\smallTensorWidth+2*\defaultTextOffsetLarge+2*\defaultDistanceEquations+2*\tensorDistance-\unitaryWidth};
		
		\node[tensorPhysicalSmall, fill=generalTensorColor] (U) at (\posX, \tensorDistance) {};
		\node[] () at (\posX+\smallTensorWidth/2+\defaultTextOffsetLarge, \tensorDistance) {$U$};
		...
		\node[] () at (\posX+\smallTensorWidth/2+\defaultTextOffsetLarge, -\tensorDistance) {$V^*$};
