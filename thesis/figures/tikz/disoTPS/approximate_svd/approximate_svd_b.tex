...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\begin{pgfonlayer}{bg}
			\draw[virtualLegSmallWithoutArrows] (E) -- ++(-\tensorDistance+\smallTensorWidth/2, 0);
		...
		\begin{pgfonlayer}{bg}
			\draw[virtualLegSmall] (R) -- (Q);
			\draw[virtualLegSmall] (Q)+(-\tensorDistance+\smallTensorWidth/2, 0) -- (Q);
