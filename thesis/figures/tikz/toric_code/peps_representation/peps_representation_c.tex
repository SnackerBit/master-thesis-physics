...
\begin{document}
	...
	\begin{tikzpicture}
		% Draw lattice
		\draw[virtualLegWithoutArrows] (0.25*\tensorDistance, 2.25*\tensorDistance) -- ++(1.5*\tensorDistance, 1.5*\tensorDistance);
		\draw[virtualLegWithoutArrows] (0.25*\tensorDistance, 0.25*\tensorDistance) -- (3.75*\tensorDistance, 3.75*\tensorDistance);
		\draw[virtualLegWithoutArrows] (2.25*\tensorDistance, 0.25*\tensorDistance) -- ++(1.5*\tensorDistance, 1.5*\tensorDistance);
		\draw[virtualLegWithoutArrows] (0.75*\tensorDistance, 0.25*\tensorDistance) -- ++(-0.5*\tensorDistance, 0.5*\tensorDistance);
		\draw[virtualLegWithoutArrows] (2.75*\tensorDistance, 0.25*\tensorDistance) -- ++(-2.5*\tensorDistance, 2.5*\tensorDistance);
		\draw[virtualLegWithoutArrows] (3.75*\tensorDistance, 1.25*\tensorDistance) -- ++(-2.5*\tensorDistance, 2.5*\tensorDistance);
		\draw[virtualLegWithoutArrows] (3.75*\tensorDistance, 3.25*\tensorDistance) -- ++(-0.5*\tensorDistance, 0.5*\tensorDistance);
