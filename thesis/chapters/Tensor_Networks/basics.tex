...
\caption{Tensors of different ranks are shown in diagrammatic notation. (a) A scalar, (b) a vector, (c) a matrix, (d) a general tensor of rank $n$ as defined in equation \eqref{eq:general_tensor_rank_n}. \todo{Change N to n}}
...
A \textit{tensor network} is defined as a set of tensors that are contracted in a specified way. We draw the tensor diagrams of a few simple tensor networks in figure \figref{fig:basic_tensor_network_diagrams}.\par
\begin{figure}[h]
	\centering
	% Store largest image in a box
