...
\begin{figure}
	...
	\caption{(a) An isometric tensor network $\mathcal{N}$ with the orthogonality center depicted in orange. The sub-network $\mathcal{M}$ is made up of all tensors in the red region. (b) The isometric tensor network $\mathcal{N}^\prime$ with an updated sub-network $\mathcal{M}^\prime$. (c) The computation of the trace $\Tr\left(\mathcal{N}\mathcal{N}^\prime\right)$ reduces to a contraction of the subregions $\Tr\left(\mathcal{M}\mathcal{M}^\prime\right)$ because of the isometry condition.\todo{Maybe scale this figure down, especially (c)?}}
