...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\node[] () at ({-\diagonalDistance+(-2*\smallestDistance-\diagonalDistance)*\openAuxillaryLegMultiplier-\braceOffsetX-59pt}, -\braketDistance/2) {$\Re\langle\Psi^\prime|\hat{U}^{[i,j]}(\Delta t)|\Psi\rangle=\Re$};
