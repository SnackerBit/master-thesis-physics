...
\pgfdeclarelayer{ops3}
\pgfdeclarelayer{ops4}
\pgfdeclarelayer{ops5}
\pgfdeclarelayer{oplegs} % declare layer for operator legs
\pgfdeclarelayer{oplegs2}
\pgfdeclarelayer{oplegs3}
\pgfdeclarelayer{oplegs4}
\pgfdeclarelayer{oplegs5}
\pgfdeclarelayer{oplegsbehindtensors}
\pgfsetlayers{bg,oplegsbehindtensors,tensors,oplegs,ops,oplegs2,ops2,oplegs3,ops3,oplegs4,ops4,oplegs5,ops5,main} % set order of layers
\begin{document}
	...
	\begin{tikzpicture}
		...
		\node[] () at ({2*\pictureWidth*\pictureScale-\equationDistance*\pictureScale/2}, 2.5*\diagonalDistance*\pictureScale) {$\rightarrow$};
		\node[] () at ({2*\pictureWidth*\pictureScale-\equationDistance*\pictureScale/2+\dotDistance*\pictureScale}, 2.5*\diagonalDistance*\pictureScale) {$\rightarrow$};
		\node[] () at ({2*\pictureWidth*\pictureScale-\equationDistance*\pictureScale/2+\dotDistance*\pictureScale/2+1pt}, 2.5*\diagonalDistance*\pictureScale) {$\cdots$};
		
		\node[] () at ({\pictureWidth*\pictureScale-\equationDistance*\pictureScale/2}, 2.5*\diagonalDistance*\pictureScale-\pictureHeight*\pictureScale) {$\rightarrow$};
		\node[] () at ({2*\pictureWidth*\pictureScale-\equationDistance*\pictureScale/2}, 2.5*\diagonalDistance*\pictureScale-\pictureHeight*\pictureScale) {$\rightarrow$};
		\node[] () at ({2*\pictureWidth*\pictureScale-\equationDistance*\pictureScale/2+\dotDistance*\pictureScale}, 2.5*\diagonalDistance*\pictureScale-\pictureHeight*\pictureScale) {$\rightarrow$};
		\node[] () at ({2*\pictureWidth*\pictureScale-\equationDistance*\pictureScale/2+\dotDistance*\pictureScale/2+1pt}, 2.5*\diagonalDistance*\pictureScale-\pictureHeight*\pictureScale) {$\cdots$};
		...
		\begin{scope}[scale=\pictureScale]
			...
			\def\posX{3*\smallestDistance+\perspectiveShift}
			...
			\def\posY{2*\diagonalDistance+2*\operatorHeight+2*\operatorDist}
			\begin{pgfonlayer}{ops3}
				\draw[virtualLegSmallWithoutArrows, fill=color1, rounded corners=\cornerRounding] (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY}) -- (\posX+3*\smallestDistance+\longOperatorEnlargementX+\perspectiveShift, \posY+\diagonalDistance+\physicalLegLength+\longOperatorEnlargementY) -- ++(0, \operatorHeight) -- (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs3}
				\draw[physicalLegSmall] (\posX, \posY+\physicalLegLength+\operatorHeight+\operatorDist) -- ++(0, -\operatorDist);
				\draw[physicalLegSmall] (\posX+3*\smallestDistance+\perspectiveShift, {\posY+\diagonalDistance+\physicalLegLength+\operatorHeight+\operatorDist}) -- ++(0, -\operatorDist);
			\end{pgfonlayer}
		
			\def\posX{5*\smallestDistance+3*\perspectiveShift}
			\def\posY{3*\diagonalDistance+3*\operatorDist+3*\operatorHeight}
			\begin{pgfonlayer}{ops4}
				\draw[virtualLegSmallWithoutArrows, fill=color2, rounded corners=\cornerRounding] (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY}) -- (\posX-\shortOperatorEnlargementX-\smallestDistance+\perspectiveShift, {\posY+\physicalLegLength+\shortOperatorEnlargementY+\diagonalDistance}) -- ++(0, \operatorHeight) -- (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs4}
				\draw[physicalLegSmall] (\posX, \posY+\physicalLegLength+\operatorHeight+\operatorDist) -- ++(0, -\operatorDist);
				\draw[physicalLegSmall] (\posX-\smallestDistance+\perspectiveShift, {\posY+\physicalLegLength+\diagonalDistance+\operatorHeight+\operatorDist}) -- ++(0, -\operatorDist);
			\end{pgfonlayer}
			
			\def\posX{4*\smallestDistance+4*\perspectiveShift}
			\def\posY{4*\diagonalDistance+4*\operatorHeight+4*\operatorDist}
			\begin{pgfonlayer}{ops5}
				\draw[virtualLegSmallWithoutArrows, fill=color1, rounded corners=\cornerRounding] (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY}) -- (\posX+3*\smallestDistance+\longOperatorEnlargementX+\perspectiveShift, \posY+\diagonalDistance+\physicalLegLength+\longOperatorEnlargementY) -- ++(0, \operatorHeight) -- (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs5}
				\draw[physicalLegSmall] (\posX, \posY+\physicalLegLength+\operatorHeight+\operatorDist) -- ++(0, -\operatorDist);
				\draw[physicalLegSmall] (\posX+3*\smallestDistance+\perspectiveShift, {\posY+\diagonalDistance+\physicalLegLength+\operatorHeight+\operatorDist}) -- ++(0, -\operatorDist);
			\end{pgfonlayer}
		
			% legs connecting to operators
			\begin{pgfonlayer}{oplegsbehindtensors}
				\draw[physicalLegSmallWithoutArrows] (T010) -- ++(0, \physicalLegLength+\operatorDist+\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T011) -- ++(0, \physicalLegLength+2*\operatorDist+2*\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T020) -- ++(0, \physicalLegLength+3*\operatorDist+3*\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T021) -- ++(0, \physicalLegLength+4*\operatorDist+4*\operatorHeight);
			\end{pgfonlayer}
		...
		\begin{scope}[scale=\pictureScale, xshift={\pictureWidth}]
			\begin{pgfonlayer}{tensors}
				...
				% auxillary tensors
				\node[tensorOrthoCenterSmall] (W1) at (3.5*\smallestDistance+0.5*\perspectiveShift, 0.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W2) at (4.5*\smallestDistance+1.5*\perspectiveShift, 1.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W3) at (5.5*\smallestDistance+2.5*\perspectiveShift, 2.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W4) at (6.5*\smallestDistance+3.5*\perspectiveShift, 3.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W5) at (7.5*\smallestDistance+4.5*\perspectiveShift, 4.5*\diagonalDistance) {};
			\end{pgfonlayer}
			...
			\def\posY{0}
			\begin{pgfonlayer}{ops2}
				\draw[virtualLegSmallWithoutArrows, fill=color3, rounded corners=\cornerRounding] (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY}) -- (\posX-\shortOperatorEnlargementX-\smallestDistance+\perspectiveShift, {\posY+\physicalLegLength+\shortOperatorEnlargementY+\diagonalDistance}) -- ++(0, \operatorHeight) -- (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs2}
				\draw[physicalLegSmall] (\posX, \posY+\physicalLegLength+\operatorHeight+\operatorDist) -- ++(0, -\operatorDist);
				\draw[physicalLegSmall] (\posX-\smallestDistance+\perspectiveShift, {\posY+\physicalLegLength+\diagonalDistance+\operatorHeight+\operatorDist}) -- ++(0, -\operatorDist);
			...
			\def\posY{\diagonalDistance+\operatorHeight+\operatorDist}
			\begin{pgfonlayer}{ops}
				\draw[virtualLegSmallWithoutArrows, fill=color4, rounded corners=\cornerRounding] (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY}) -- (\posX+3*\smallestDistance+\longOperatorEnlargementX+\perspectiveShift, \posY+\diagonalDistance+\physicalLegLength+\longOperatorEnlargementY) -- ++(0, \operatorHeight) -- (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs}
				\draw[physicalLegSmall] (\posX, \posY+\physicalLegLength+\operatorHeight+\operatorDist) -- ++(0, -\operatorDist);
				\draw[physicalLegSmall] (\posX+3*\smallestDistance+\perspectiveShift, {\posY+\diagonalDistance+\physicalLegLength+\operatorHeight+\operatorDist}) -- ++(0, -\operatorDist);
			...
			\def\posX{5*\smallestDistance+3*\perspectiveShift}
			\def\posY{3*\diagonalDistance+3*\operatorHeight+3*\operatorDist}
			\begin{pgfonlayer}{ops}
				\draw[virtualLegSmallWithoutArrows, fill=color4, rounded corners=\cornerRounding] (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY}) -- (\posX+3*\smallestDistance+\longOperatorEnlargementX+\perspectiveShift, \posY+\diagonalDistance+\physicalLegLength+\longOperatorEnlargementY) -- ++(0, \operatorHeight) -- (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs}
			...
			% legs connecting to operators
			\begin{pgfonlayer}{oplegsbehindtensors}
				\draw[physicalLegSmallWithoutArrows] (T110) -- ++(0, \physicalLegLength+\operatorDist+\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T011) -- ++(0, \physicalLegLength+2*\operatorDist+2*\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T120) -- ++(0, \physicalLegLength+3*\operatorDist+3*\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T021) -- ++(0, \physicalLegLength+4*\operatorDist+4*\operatorHeight);
			\end{pgfonlayer}
		...
		\iffalse
		\begin{scope}[scale=\pictureScale, xshift={2*\pictureWidth}]
			\begin{pgfonlayer}{tensors}
					% physical tensors 1st column
				\node[tensorPhysicalSmall] (T000) at (0, 0) {};
				\node[tensorPhysicalSmall] (T010) at (2*\smallestDistance+2*\perspectiveShift, 2*\diagonalDistance) {};
			...
			\begin{pgfonlayer}{oplegsbehindtensors}
				\draw[physicalLegSmallWithoutArrows] (T110) -- ++(0, \physicalLegLength+\operatorDist+\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T111) -- ++(0, \physicalLegLength+2*\operatorDist+2*\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T120) -- ++(0, \physicalLegLength+3*\operatorDist+3*\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T121) -- ++(0, \physicalLegLength+4*\operatorDist+4*\operatorHeight);
			\end{pgfonlayer}
		...
		\begin{scope}[scale=\pictureScale, xshift={2*\pictureWidth+\dotDistance}, yshift=0]
			\begin{pgfonlayer}{tensors}
					% physical tensors 1st column
				\node[tensorPhysicalSmall] (T000) at (0, 0) {};
				\node[tensorPhysicalSmall] (T010) at (2*\smallestDistance+2*\perspectiveShift, 2*\diagonalDistance) {};
				...
				% auxillary tensors
				\node[tensorOrthoCenterSmall] (W1) at (9.5*\smallestDistance+0.5*\perspectiveShift, 0.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W2) at (10.5*\smallestDistance+1.5*\perspectiveShift, 1.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W3) at (11.5*\smallestDistance+2.5*\perspectiveShift, 2.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W4) at (12.5*\smallestDistance+3.5*\perspectiveShift, 3.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W5) at (13.5*\smallestDistance+4.5*\perspectiveShift, 4.5*\diagonalDistance) {};
			\end{pgfonlayer}
			
			% operators
			\def\posX{8*\smallestDistance}
			\def\posY{0}
			\begin{pgfonlayer}{ops}
				\draw[virtualLegSmallWithoutArrows, fill=color1, rounded corners=\cornerRounding] (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY}) -- (\posX+3*\smallestDistance+\longOperatorEnlargementX+\perspectiveShift, \posY+\diagonalDistance+\physicalLegLength+\longOperatorEnlargementY) -- ++(0, \operatorHeight) -- (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			...
			\def\posX{11*\smallestDistance+1*\perspectiveShift}
			\def\posY{\diagonalDistance+\operatorDist+\operatorHeight}
			\begin{pgfonlayer}{ops2}
				\draw[virtualLegSmallWithoutArrows, fill=color2, rounded corners=\cornerRounding] (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY}) -- (\posX-\shortOperatorEnlargementX-\smallestDistance+\perspectiveShift, {\posY+\physicalLegLength+\shortOperatorEnlargementY+\diagonalDistance}) -- ++(0, \operatorHeight) -- (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			...
			\def\posX{10*\smallestDistance+2*\perspectiveShift}
			\def\posY{2*\diagonalDistance+2*\operatorHeight+2*\operatorDist}
			\begin{pgfonlayer}{ops}
				\draw[virtualLegSmallWithoutArrows, fill=color1, rounded corners=\cornerRounding] (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY}) -- (\posX+3*\smallestDistance+\longOperatorEnlargementX+\perspectiveShift, \posY+\diagonalDistance+\physicalLegLength+\longOperatorEnlargementY) -- ++(0, \operatorHeight) -- (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			...
			\def\posX{13*\smallestDistance+3*\perspectiveShift}
			\def\posY{3*\diagonalDistance+3*\operatorDist+3*\operatorHeight}
			\begin{pgfonlayer}{ops2}
				\draw[virtualLegSmallWithoutArrows, fill=color2, rounded corners=\cornerRounding] (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY}) -- (\posX-\shortOperatorEnlargementX-\smallestDistance+\perspectiveShift, {\posY+\physicalLegLength+\shortOperatorEnlargementY+\diagonalDistance}) -- ++(0, \operatorHeight) -- (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			...
			\def\posX{12*\smallestDistance+4*\perspectiveShift}
			\def\posY{4*\diagonalDistance+4*\operatorHeight+4*\operatorDist}
			\begin{pgfonlayer}{ops}
				\draw[virtualLegSmallWithoutArrows, fill=color1, rounded corners=\cornerRounding] (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY}) -- (\posX+3*\smallestDistance+\longOperatorEnlargementX+\perspectiveShift, \posY+\diagonalDistance+\physicalLegLength+\longOperatorEnlargementY) -- ++(0, \operatorHeight) -- (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			...
			% legs connecting to operators
			\begin{pgfonlayer}{oplegsbehindtensors}
				\draw[physicalLegSmallWithoutArrows] (T210) -- ++(0, \physicalLegLength+\operatorDist+\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T211) -- ++(0, \physicalLegLength+2*\operatorDist+2*\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T220) -- ++(0, \physicalLegLength+3*\operatorDist+3*\operatorHeight);
				\draw[physicalLegSmallWithoutArrows] (T221) -- ++(0, \physicalLegLength+4*\operatorDist+4*\operatorHeight);
			\end{pgfonlayer}
			...
			\begin{pgfonlayer}{bg}
				...
				\draw[virtualLegSmall] (T101) -- (T200);
				\draw[virtualLegSmall] (T111) -- (T210);
				\draw[virtualLegSmall] (T121) -- (T220);
				\draw[virtualLegSmall] (T101) -- (T210);
				\draw[virtualLegSmall] (T111) -- (T220);
				...
				\draw[virtualLegSmall] (T201) -- (W1);
				\draw[virtualLegSmall] (T201) -- (W2);
				\draw[virtualLegSmall] (T210) -- (W2);
				\draw[virtualLegSmall] (T211) -- (W3);
				\draw[virtualLegSmall] (T210) -- (W3);
				\draw[virtualLegSmall] (T211) -- (W4);
				\draw[virtualLegSmall] (T220) -- (W4);
				\draw[virtualLegSmall] (T221) -- (W5);
				\draw[virtualLegSmall] (T220) -- (W5);
		...
		\begin{scope}[scale=\pictureScale, xshift=0, yshift=-\pictureHeight]
			\begin{pgfonlayer}{tensors}
					% physical tensors 1st column
				\node[tensorPhysicalSmall] (T000) at (0, 0) {};
				\node[tensorPhysicalSmall] (T010) at (2*\smallestDistance+2*\perspectiveShift, 2*\diagonalDistance) {};
			...
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs}
				\draw[physicalLegSmall] (\posX, \posY+\physicalLegLength+\operatorHeight+\operatorDistBackwards) -- ++(0, -\operatorDistBackwards);
				\draw[physicalLegSmall] (\posX+3*\smallestDistance+\perspectiveShift, {\posY+\diagonalDistance+\physicalLegLength+\operatorHeight+\operatorDist}) -- ++(0, -\operatorDist);
			\end{pgfonlayer}
		
			\def\posX{13*\smallestDistance+3*\perspectiveShift}
			\def\posY{3*\diagonalDistance+\operatorDistBackwards+\operatorHeight}
			\begin{pgfonlayer}{ops2}
				\draw[virtualLegSmallWithoutArrows, fill=color2, rounded corners=\cornerRounding] (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY}) -- (\posX-\shortOperatorEnlargementX-\smallestDistance+\perspectiveShift, {\posY+\physicalLegLength+\shortOperatorEnlargementY+\diagonalDistance}) -- ++(0, \operatorHeight) -- (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs2}
			...
			\def\posX{10*\smallestDistance+2*\perspectiveShift}
			\def\posY{2*\diagonalDistance+2*\operatorHeight+2*\operatorDistBackwards}
			\begin{pgfonlayer}{ops3}
				\draw[virtualLegSmallWithoutArrows, fill=color1, rounded corners=\cornerRounding] (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY}) -- (\posX+3*\smallestDistance+\longOperatorEnlargementX+\perspectiveShift, \posY+\diagonalDistance+\physicalLegLength+\longOperatorEnlargementY) -- ++(0, \operatorHeight) -- (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs3}
			...
			\def\posX{11*\smallestDistance+1*\perspectiveShift}
			\def\posY{\diagonalDistance+3*\operatorDistBackwards+3*\operatorHeight}
			\begin{pgfonlayer}{ops4}
				\draw[virtualLegSmallWithoutArrows, fill=color2, rounded corners=\cornerRounding] (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY}) -- (\posX-\shortOperatorEnlargementX-\smallestDistance+\perspectiveShift, {\posY+\physicalLegLength+\shortOperatorEnlargementY+\diagonalDistance}) -- ++(0, \operatorHeight) -- (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs4}
			...
			\def\posX{8*\smallestDistance}
			\def\posY{4*\operatorDistBackwards+4*\operatorHeight}
			\begin{pgfonlayer}{ops5}
				\draw[virtualLegSmallWithoutArrows, fill=color1, rounded corners=\cornerRounding] (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY}) -- (\posX+3*\smallestDistance+\longOperatorEnlargementX+\perspectiveShift, \posY+\diagonalDistance+\physicalLegLength+\longOperatorEnlargementY) -- ++(0, \operatorHeight) -- (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs5}
			...
			% legs connecting to operators
			\begin{pgfonlayer}{oplegs5}
				\draw[physicalLegSmallWithoutArrows] (8*\smallestDistance, \physicalLegLength) -- ++(0, \physicalLegLength+4*\operatorDistBackwards+4*\operatorHeight-\physicalLegLength); % starting at T200
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs4}
				\draw[physicalLegSmallWithoutArrows] (11*\smallestDistance+\perspectiveShift, \diagonalDistance+\physicalLegLength) -- ++(0, \physicalLegLength+3*\operatorDistBackwards+3*\operatorHeight-\physicalLegLength); % starting at T201
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs3}
				\draw[physicalLegSmallWithoutArrows] (10*\smallestDistance+2*\perspectiveShift, 2*\diagonalDistance+\physicalLegLength) -- ++(0, \physicalLegLength+2*\operatorDistBackwards+2*\operatorHeight-\physicalLegLength); % starting at T210
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs2}
				\draw[physicalLegSmallWithoutArrows] (13*\smallestDistance+3*\perspectiveShift, 3*\diagonalDistance+\physicalLegLength) -- ++(0, \physicalLegLength+1*\operatorDistBackwards+1*\operatorHeight-\physicalLegLength); % starting at T211
			\end{pgfonlayer}
			...
			\begin{pgfonlayer}{bg}
				...
				\draw[auxillaryLegSmall] (W2) -- (W3);
				\draw[auxillaryLegSmall] (W3) -- (W4);
				\draw[auxillaryLegSmall] (W4) -- (W5);
		...
		\begin{scope}[scale=\pictureScale, xshift={\pictureWidth}, yshift=-\pictureHeight]
			\begin{pgfonlayer}{tensors}
				% physical tensors 1st column
				\node[tensorPhysicalSmall] (T000) at (0, 0) {};
				\node[tensorPhysicalSmall] (T010) at (2*\smallestDistance+2*\perspectiveShift, 2*\diagonalDistance) {};
				...
				% auxillary tensors
				\node[tensorOrthoCenterSmall] (W1) at (7.5*\smallestDistance+0.5*\perspectiveShift, 0.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W2) at (8.5*\smallestDistance+1.5*\perspectiveShift, 1.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W3) at (9.5*\smallestDistance+2.5*\perspectiveShift, 2.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W4) at (10.5*\smallestDistance+3.5*\perspectiveShift, 3.5*\diagonalDistance) {};
				\node[tensorAuxillarySmall] (W5) at (11.5*\smallestDistance+4.5*\perspectiveShift, 4.5*\diagonalDistance) {};
			\end{pgfonlayer}
			...
			\def\posX{9*\smallestDistance+3*\perspectiveShift}
			\def\posY{3*\diagonalDistance+\operatorHeight+\operatorDistBackwards}
			\begin{pgfonlayer}{ops2}
				\draw[virtualLegSmallWithoutArrows, fill=color4, rounded corners=\cornerRounding] (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY}) -- (\posX+3*\smallestDistance+\longOperatorEnlargementX+\perspectiveShift, \posY+\diagonalDistance+\physicalLegLength+\longOperatorEnlargementY) -- ++(0, \operatorHeight) -- (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs2}
			...
			\def\posX{7*\smallestDistance+1*\perspectiveShift}
			\def\posY{\diagonalDistance+3*\operatorHeight+3*\operatorDistBackwards}
			\begin{pgfonlayer}{ops4}
				\draw[virtualLegSmallWithoutArrows, fill=color4, rounded corners=\cornerRounding] (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY}) -- (\posX+3*\smallestDistance+\longOperatorEnlargementX+\perspectiveShift, \posY+\diagonalDistance+\physicalLegLength+\longOperatorEnlargementY) -- ++(0, \operatorHeight) -- (\posX-\longOperatorEnlargementX, {\posY+\physicalLegLength-\longOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs4}
			...
			\def\posX{8*\smallestDistance}
			\def\posY{4*\operatorHeight+4*\operatorDistBackwards}
			\begin{pgfonlayer}{ops5}
				\draw[virtualLegSmallWithoutArrows, fill=color3, rounded corners=\cornerRounding] (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY}) -- (\posX-\shortOperatorEnlargementX-\smallestDistance+\perspectiveShift, {\posY+\physicalLegLength+\shortOperatorEnlargementY+\diagonalDistance}) -- ++(0, \operatorHeight) -- (\posX+\shortOperatorEnlargementX, {\posY+\physicalLegLength-\shortOperatorEnlargementY+\operatorHeight}) -- cycle;
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs5}
			...
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs4}
				\draw[physicalLegSmallWithoutArrows] (7*\smallestDistance+\perspectiveShift, \diagonalDistance+\physicalLegLength) -- ++(0, \physicalLegLength+3*\operatorDistBackwards+3*\operatorHeight-\physicalLegLength); % starting at T101
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs3}
				\draw[physicalLegSmallWithoutArrows] (10*\smallestDistance+2*\perspectiveShift, 2*\diagonalDistance+\physicalLegLength) -- ++(0, \physicalLegLength+2*\operatorDistBackwards+2*\operatorHeight-\physicalLegLength); % starting at T210
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs2}
				\draw[physicalLegSmallWithoutArrows] (9*\smallestDistance+3*\perspectiveShift, 3*\diagonalDistance+\physicalLegLength) -- ++(0, \physicalLegLength+1*\operatorDistBackwards+1*\operatorHeight-\physicalLegLength); % starting at T111
			\end{pgfonlayer}
		...
		\begin{scope}[scale=\pictureScale, xshift={2*\pictureWidth+\dotDistance}, yshift=-\pictureHeight]
			\begin{pgfonlayer}{tensors}
				% physical tensors 1st column
				\node[tensorPhysicalSmall] (T000) at (0, 0) {};
				\node[tensorPhysicalSmall] (T010) at (2*\smallestDistance+2*\perspectiveShift, 2*\diagonalDistance) {};
			...
			% legs connecting to operators
			\begin{pgfonlayer}{oplegs5}
				\draw[physicalLegSmallWithoutArrows] (0, \physicalLegLength) -- ++(0, \physicalLegLength+4*\operatorDistBackwards+4*\operatorHeight-\physicalLegLength); % starting at T200
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs4}
				\draw[physicalLegSmallWithoutArrows] (3*\smallestDistance+\perspectiveShift, \diagonalDistance+\physicalLegLength) -- ++(0, \physicalLegLength+3*\operatorDistBackwards+3*\operatorHeight-\physicalLegLength); % starting at T201
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs3}
				\draw[physicalLegSmallWithoutArrows] (2*\smallestDistance+2*\perspectiveShift, 2*\diagonalDistance+\physicalLegLength) -- ++(0, \physicalLegLength+2*\operatorDistBackwards+2*\operatorHeight-\physicalLegLength); % starting at T210
			\end{pgfonlayer}
			\begin{pgfonlayer}{oplegs2}
				\draw[physicalLegSmallWithoutArrows] (5*\smallestDistance+3*\perspectiveShift, 3*\diagonalDistance+\physicalLegLength) -- ++(0, \physicalLegLength+1*\operatorDistBackwards+1*\operatorHeight-\physicalLegLength); % starting at T211
			\end{pgfonlayer}
