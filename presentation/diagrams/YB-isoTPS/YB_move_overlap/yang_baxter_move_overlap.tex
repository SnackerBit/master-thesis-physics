...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\node[] () at ({-2*\smallestDistance+(-2*\smallestDistance-\diagonalDistance)*\openAuxillaryLegMultiplier+\braceOffsetX-\braceWidth-37pt}, \ketDiagonalShiftY-\braketDistance/2) {$\Re\langle\Psi^\prime|\Psi\rangle = \Re$};
