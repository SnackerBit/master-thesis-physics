...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\node[tensorOrthoCenterSmall] (T21) at (\tensorDistance, 0) {};
		...
		\begin{pgfonlayer}{bg}
			% Mark TEBD
			\fill[color=redMarkingColor, opacity=\backgroundopacity] \convexhull{T21, T25}{\smallTensorWidth*0.8};
		\end{pgfonlayer}
		...
		\begin{pgfonlayer}{bg}
			...
			\draw[auxillaryLegSmall] (T31) -- (T21);
